...
const int Info1_OffsetToSend = 0002;
const int Info2_OffsetToSend = 0003;
...
{
  Modbus_IP.addIreg(Info1_OffsetToSend);
  Modbus_IP.addIreg(Info2_OffsetToSend);
}
...
{
  Modbus_IP.task();
  Modbus_IP.Ireg(Info1_OffsetToSend, Potenciometro_1.toInt());
  Modbus_IP.Ireg(Info2_OffsetToSend, Potenciometro_2.toInt());
